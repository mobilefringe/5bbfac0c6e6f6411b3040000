                ...
                updateCurrentPromo (id) {
                    ...
                    if (this.currentPromo != null || this.currentPromo != undefined){
                        ...
                        if(_.includes(this.currentPromo.image_url, 'missing')) {
                            this.currentPromo.image_url = //codecloud.cdn.speedyrails.net/sites/5bbfac0c6e6f6411b3040000/image/png/1546551307522/eventplaceholder2@2x.png;
                        }
                        if(_.includes(this.currentPromo.promo_image2_url_abs, 'missing')) {
                            this.currentPromo.promo_image2_url_abs = //codecloud.cdn.speedyrails.net/sites/5bbfac0c6e6f6411b3040000/image/png/1546551307522/eventplaceholder2@2x.png;
                        }
