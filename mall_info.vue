                ...
                <div class="page_header" v-if="pageBanner" v-bind:style="{ background: '#000 url(' + pageBanner.image_url + ')' }">
        			<div class="site_container">
        				<div class="header_content caps">
        					<h1 class="banner-content">{{ $t("mall_info.info_header") }}</h1>
        				</div>
        			</div>
        		</div>
        		<div class="site_container">
        		    ...
        		    <div class="row mall_info_images">
        			    <div class="col-sm-6">
        			        <img class="max_width" src="//codecloud.cdn.speedyrails.net/sites/5daf7e206e6f643cde010000/image/jpeg/1540398641000/pages1.jpg" alt="" />
        			    </div>
        			   <div class="col-sm-6">
        			       <img class="max_width" src="//codecloud.cdn.speedyrails.net/sites/5daf7e206e6f643cde010000/image/jpeg/1540398677000/pages2.jpg" alt="" />
        			   </div>
        		    </div>
                </div>
            </div>
