			...
			<div class="header_logo">
				...
				<div class="mobile_header">
				    <div class="property_logo center-block">
						<router-link to="/">
						    <img src="//codecloud.cdn.speedyrails.net/sites/5bbfac0c6e6f6411b3040000/image/png/1539292470000/southland-mall-logo2-01-compressor.png" :alt="property.name + ' Logo'"/>
					    </router-link>
					</div>
				...
				<div class="hidden_phone">
					...
					<script type="text/javascript">
                        ...
                        function googleTranslateElementInit() {
                          new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'en,fr,zh-CN,zh-TW,es,tl', layout: google.translate.TranslateElement.InlineLayout.SIMPLE, gaTrack: true, gaId: 'UA-40014802-31'}, 'google_translate_element');
                          setTimeout(function(){
                                    if ($( window ).width() < 768){
                                        m = true;
...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue_router", "routes", "bootstrap-vue", "google-translate"], function (Vue, Vuex, moment, tz, VueRouter, appRoutes, BootstrapVue) {
