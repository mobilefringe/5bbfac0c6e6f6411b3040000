			...
			<div class="header_logo">
				...
				<div class="mobile_header">
				    <div class="property_logo center-block">
						<router-link to="/">
						    <img src="//codecloud.cdn.speedyrails.net/sites/5daf7e206e6f643cde010000/image/png/1539292470000/southland-mall-logo2-01-compressor.png" :alt="property.name + ' Logo'"/>
					    </router-link>
					</div>
				...
				<div class="hidden_phone">
				    <div class="header_search_container">
					    <search-component v-if="headerReady" :list="searchList" placeholder="Search" :suggestion-attribute="suggestionAttribute" :keys="keys" v-model="search_result" @select="onOptionSelect" :autocomplete="false" :minMatchCharLength="3" :tokenize="true" class="text-left" inputID="fullSiteSearch" inputID="searchWebsite" siteSearchBtnID="searchWebsiteBtn">
